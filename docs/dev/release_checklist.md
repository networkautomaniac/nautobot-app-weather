...
Draft a [new release](https://github.com/networkautomaniac/nautobot-app-weather/releases/new) with the following parameters.
...
- Change the entries generated by GitHub to only the usernames of the contributors. e.g. `* Updated dockerfile by @nautobot_user in https://github.com/networkautomaniac/nautobot-app-weather/pull/123` -> `* @nautobot_user`.
...
**Full Changelog**: https://github.com/networkautomaniac/nautobot-app-weather/compare/v1.4.1...v1.4.2
```
